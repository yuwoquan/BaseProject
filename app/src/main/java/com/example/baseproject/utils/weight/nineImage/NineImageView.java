package com.example.baseproject.utils.weight.nineImage;
...
import com.example.baseproject.utils.utils.DisplayUtil;
...
public class NineImageView extends View {
    ...
    public void setImageUrls(Collection<String> imageUrls,Context context) {
