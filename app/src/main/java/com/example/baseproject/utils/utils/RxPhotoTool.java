...
public class RxPhotoTool {
    ...
    public static void openCameraImage(final QMUIFragment fragment) {
    ...
    public static void openLocalImage(final QMUIFragment fragment) {
        Intent intent = new Intent();
        intent.setType("image/*");
        intent.setAction(Intent.ACTION_GET_CONTENT);
    ...
    public static void cropImage(QMUIFragment fragment, Uri srcUri) {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(MyApplication.getContext(), "请先获取写入SDCard权限", Toast.LENGTH_SHORT).show();
