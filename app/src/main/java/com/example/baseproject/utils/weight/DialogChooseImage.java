...
public class DialogChooseImage extends RxDialog {
    ...
    public DialogChooseImage(QMUIFragment fragment) {
    ...
    public DialogChooseImage(QMUIFragment fragment, int themeResId) {
    ...
    public DialogChooseImage(QMUIFragment fragment, float alpha, int gravity) {
        super(fragment.getContext(), alpha, gravity);
        initView(fragment);
    }

    public DialogChooseImage(QMUIFragment fragment, LayoutType layoutType) {
        super(fragment.getContext());
    ...
    public DialogChooseImage(QMUIFragment fragment, int themeResId, LayoutType layoutType) {
        super(fragment.getContext(), themeResId);
        mLayoutType = layoutType;
        initView(fragment);
    }
    ...
    public DialogChooseImage(QMUIFragment fragment, float alpha, int gravity, LayoutType layoutType) {
        super(fragment.getContext(), alpha, gravity);
        mLayoutType = layoutType;
        initView(fragment);
    }
    ...
    private void initView(final QMUIFragment fragment) {
        View dialogView = null;
        switch (mLayoutType) {
            case TITLE:
                dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_picker_pictrue, null);
